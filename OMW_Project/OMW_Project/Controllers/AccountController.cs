...
namespace OMW_Project.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> EditProfile(User editUser, HttpPostedFileBase myfile, params string[] selectedRole)
        {
            ViewBag.lstCatePost = _postRepository.GetPost_Category();
            ...
            if (ModelState.IsValid)
            {
                ...
                user.Image = editUser.Image ?? user.Image;
            ...
            if (result.Succeeded)
            {
                ...
                return RedirectToAction("ToProfile");
            }
            else
            {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new User { UserName = model.Email, Email = model.Email, FullName = model.FullName, Address = model.Address, Sex = model.Sex, PhoneNumber = model.PhoneNumber };
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null || !(await UserManager.IsEmailConfirmedAsync(user.Id)))
                {
                    ...
                    ModelState.AddModelError(string.Empty, "Tài khoản không tổn tại hoặc email chưa được xác nhận !");
                    return View(model); ;
                }
